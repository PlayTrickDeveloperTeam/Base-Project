...
namespace Lean.Common
{
    ...
    public class LeanManualRotate : MonoBehaviour
    {
        ...
        [FSA("AxisA")] [SerializeField] private Vector3 axisA = Vector3.down;
        ...
        [FSA("AxisB")] [SerializeField] private Vector3 axisB = Vector3.right;
        ...
        [FSA("DefaultRotation")] [SerializeField] private Vector3 defaultRotation;
