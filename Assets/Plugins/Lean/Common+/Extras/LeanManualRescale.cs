...
namespace Lean.Common
{
    ...
    public class LeanManualRescale : MonoBehaviour
    {
        ...
        public Vector3 AxesA { set { axesA = value; } get { return axesA; } }

        [SerializeField] private Vector3 axesA = Vector3.right;

        /// <summary>The second scale axes, used when calling <b>ScaleB</b> or <b>ScaleAB</b>.</summary>
        public Vector3 AxesB { set { axesB = value; } get { return axesB; } }

        [SerializeField] private Vector3 axesB = Vector3.up;
        ...
        public Vector3 DefaultScale { set { defaultScale = value; } get { return defaultScale; } }
...
namespace Lean.Touch.Inspector
{
    ...
    [CustomEditor(typeof(LeanManualRescale))]
    public class LeanManualRescale_Inspector : Lean.Common.LeanInspector<LeanManualRescale>
    {
