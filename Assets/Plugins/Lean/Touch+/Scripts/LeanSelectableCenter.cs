...
namespace Lean.Touch
{
    ...
    public class LeanSelectableCenter : LeanSelectableBehaviour
    {
        [System.Serializable] public class Vector3Event : UnityEvent<Vector3> { }

        /// <summary>This allows you to output Seconds to UI text.</summary>
        public Vector3Event OnPosition { get { if (onPosition == null) onPosition = new Vector3Event(); return onPosition; } }
