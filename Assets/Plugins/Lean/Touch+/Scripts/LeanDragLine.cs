...
namespace Lean.Touch
{
    ...
    public class LeanDragLine : LeanDragTrail
    {
        ...
        public Vector3Event OnReleasedFrom { get { if (onReleasedFrom == null) onReleasedFrom = new Vector3Event(); return onReleasedFrom; } }

        [SerializeField] private Vector3Event onReleasedFrom;
        ...
        public Vector3Event OnReleasedTo { get { if (onReleasedTo == null) onReleasedTo = new Vector3Event(); return onReleasedTo; } }

        [SerializeField] private Vector3Event onReleasedTo;

        /// <summary>This event gets called when a trail drawing finger goes up. The parameter contains the end point in world space.
        /// Vector3 = Vector between start and end world points.</summary>
        public Vector3Event OnReleasedDelta { get { if (onReleasedDelta == null) onReleasedDelta = new Vector3Event(); return onReleasedDelta; } }

        [SerializeField] private Vector3Event onReleasedDelta;

        /// <summary>This event gets called when a trail drawing finger goes up.
        /// Vector3 = Start point in world space.
        /// Vector3 = End point in world space.</summary>
        public Vector3Vector3Event OnReleasedFromTo { get { if (onReleasedFromTo == null) onReleasedFromTo = new Vector3Vector3Event(); return onReleasedFromTo; } }

        [Space] [SerializeField] private Vector3Vector3Event onReleasedFromTo;
