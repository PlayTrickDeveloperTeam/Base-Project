...
namespace Lean.Touch
{
    ...
    public class LeanSelectableDial : LeanSelectableBehaviour
    {
        ...
        public float Angle { set { var newAngle = value; if (Clamp == true) { newAngle = Mathf.Clamp(newAngle, ClampMin, ClampMax); } if (angle != newAngle) { angle = newAngle; if (onAngleChanged != null) onAngleChanged.Invoke(angle); } } get { return angle; } }
        ...
        public FloatEvent OnAngleChanged { get { if (onAngleChanged == null) onAngleChanged = new FloatEvent(); return onAngleChanged; } }

        [SerializeField] private FloatEvent onAngleChanged;
