...
namespace Lean.Touch
{
    ...
    public class LeanMultiTap : MonoBehaviour
    {
        ...
        public UnityEvent OnTap { get { if (onTap == null) onTap = new UnityEvent(); return onTap; } }
        ...
        public IntEvent OnHighest { get { if (onHighest == null) onHighest = new IntEvent(); return onHighest; } }

        [SerializeField] private IntEvent onHighest;

        /// <summary>Called when a multi-tap occurs.
        /// Int = The amount of times you've multi-tapped.
        /// Int = The maximum amount of fingers involved in this multi-tap.</summary>
        public IntIntEvent OnCountHighest { get { if (onCountHighest == null) onCountHighest = new IntIntEvent(); return onCountHighest; } }

        [FSA("OnTap")] [SerializeField] private IntIntEvent onCountHighest;
