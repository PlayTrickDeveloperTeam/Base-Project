...
namespace Lean.Touch
{
    ...
    public class LeanSelectedText : MonoBehaviour
    {
        ...
        [SerializeField] private string format = "You have selected {1} out of {0} objects!";

        /// <summary>The formatted string will be output using this event.</summary>
        public StringEvent OnText { get { if (onText == null) onText = new StringEvent(); return onText; } }

        [SerializeField] private StringEvent onText;
