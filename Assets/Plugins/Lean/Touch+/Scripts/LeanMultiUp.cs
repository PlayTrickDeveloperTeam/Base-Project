...
namespace Lean.Touch
{
    ...
    public class LeanMultiUp : MonoBehaviour
    {
        ...
        public LeanFingerListEvent OnFingers { get { if (onFingers == null) onFingers = new LeanFingerListEvent(); return onFingers; } }

        [SerializeField] private LeanFingerListEvent onFingers;
...
namespace Lean.Touch.Inspector
{
    ...
    [CustomEditor(typeof(LeanMultiUp))]
    public class LeanMultiUp_Inspector : Lean.Common.LeanInspector<LeanMultiUp>
    {
