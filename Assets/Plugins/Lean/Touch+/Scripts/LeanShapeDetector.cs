...
namespace Lean.Touch
{
    ...
    public class LeanShapeDetector : MonoBehaviour
    {
        ...
        public LeanFingerEvent OnDetected { get { if (onDetected == null) onDetected = new LeanFingerEvent(); return onDetected; } }

        [SerializeField] private LeanFingerEvent onDetected;
