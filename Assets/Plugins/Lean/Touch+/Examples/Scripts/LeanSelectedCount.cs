...
namespace Lean.Touch
{
    ...
    public class LeanSelectedCount : MonoBehaviour
    {
        ...
        public UnityEvent OnMatch { get { if (onMatch == null) onMatch = new UnityEvent(); return onMatch; } }
        ...
        public UnityEvent OnUnmatch { get { if (onUnmatch == null) onUnmatch = new UnityEvent(); return onUnmatch; } }

        [SerializeField] private UnityEvent onUnmatch;
