...
namespace Lean.Touch
{
    ...
    public class LeanSelectable : MonoBehaviour
    {
        ...
        public LeanFingerEvent OnSelect { get { if (onSelect == null) onSelect = new LeanFingerEvent(); return onSelect; } }

        [FSA("OnSelect")] [SerializeField] private LeanFingerEvent onSelect;
        ...
        public LeanFingerEvent OnSelectUpdate { get { if (onSelectUpdate == null) onSelectUpdate = new LeanFingerEvent(); return onSelectUpdate; } }

        [FSA("onSelectSet")] [FSA("OnSelectSet")] [SerializeField] private LeanFingerEvent onSelectUpdate;

        /// <summary>This event is called when the selecting finger goes up (finger = the finger that selected this).</summary>
        public LeanFingerEvent OnSelectUp { get { if (onSelectUp == null) onSelectUp = new LeanFingerEvent(); return onSelectUp; } }

        [FSA("OnSelectUp")] [SerializeField] private LeanFingerEvent onSelectUp;
        ...
        public UnityEvent OnDeselect { get { if (onDeselect == null) onDeselect = new UnityEvent(); return onDeselect; } }
