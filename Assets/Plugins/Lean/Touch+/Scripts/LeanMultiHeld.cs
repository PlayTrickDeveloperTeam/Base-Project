...
namespace Lean.Touch
{
    ...
    public class LeanMultiHeld : MonoBehaviour
    {
        ...
        public LeanFingerListEvent OnFingersDown { get { if (onFingersDown == null) onFingersDown = new LeanFingerListEvent(); return onFingersDown; } }

        [SerializeField] private LeanFingerListEvent onFingersDown;

        /// <summary>This event will be called if the above conditions are met when you begin holding fingers down.</summary>
        public LeanFingerListEvent OnFingersUpdate { get { if (onFingersUpdate == null) onFingersUpdate = new LeanFingerListEvent(); return onFingersUpdate; } }

        [SerializeField] private LeanFingerListEvent onFingersUpdate;

        /// <summary>This event will be called if the above conditions are no longer met.</summary>
        public LeanFingerListEvent OnFingersUp { get { if (onFingersUp == null) onFingersUp = new LeanFingerListEvent(); return onFingersUp; } }

        [SerializeField] private LeanFingerListEvent onFingersUp;
        ...
        public Vector3Event OnWorldDown { get { if (onWorldDown == null) onWorldDown = new Vector3Event(); return onWorldDown; } }

        [SerializeField] private Vector3Event onWorldDown;

        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector3 = Finger position in world space.</summary>
        public Vector3Event OnWorldUpdate { get { if (onWorldUpdate == null) onWorldUpdate = new Vector3Event(); return onWorldUpdate; } }

        [SerializeField] private Vector3Event onWorldUpdate;

        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector3 = Finger position in world space.</summary>
        public Vector3Event OnWorldUp { get { if (onWorldUp == null) onWorldUp = new Vector3Event(); return onWorldUp; } }

        [SerializeField] private Vector3Event onWorldUp;

        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector2 = Finger position in screen space.</summary>
        public Vector2Event OnScreenDown { get { if (onScreenDown == null) onScreenDown = new Vector2Event(); return onScreenDown; } }

        [SerializeField] private Vector2Event onScreenDown;

        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector2 = Finger position in screen space.</summary>
        public Vector2Event OnScreenUpdate { get { if (onScreenUpdate == null) onScreenUpdate = new Vector2Event(); return onScreenUpdate; } }

        [SerializeField] private Vector2Event onScreenUpdate;

        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector2 = Finger position in screen space.</summary>
        public Vector2Event OnScreenUp { get { if (onScreenUp == null) onScreenUp = new Vector2Event(); return onScreenUp; } }

        [SerializeField] private Vector2Event onScreenUp;
