...
namespace Lean.Touch
{
    ...
    public class LeanDrop : MonoBehaviour, IDropHandler
    {
        ...
        public GameObjectLeanFingerEvent OnDropped { get { if (onDropped == null) onDropped = new GameObjectLeanFingerEvent(); return onDropped; } }

        [SerializeField] private GameObjectLeanFingerEvent onDropped;
