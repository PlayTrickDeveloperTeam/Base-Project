...
public class EditorInGame : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (open)
        {
            ...
            if (GUI.Button(new Rect(225, 275, 200, 50), "RES LEVEL", myButtonStyle))
            {
            ...
            {
                B_GM_GameManager.instance.ActivateEndgame(true,0f);
            }
            
            if (GUI.Button(new Rect(675, 275, 200, 50), "F. GAME(F)", myButtonStyle))
            {
                B_GM_GameManager.instance.ActivateEndgame(false,0f);
            }
        }
    ...
    //     } else
    //     {
    //         turnButton = new Rect(225, 100, 200, 50);
    //         turnStat = "CLOSE";
    //     }
    //     
    // }
