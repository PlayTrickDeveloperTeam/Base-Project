...
namespace Lean.Touch
{
    ...
    public class LeanMultiTwist : MonoBehaviour
    {
        ...
        public FloatEvent OnTwistDegrees { get { if (onTwistDegrees == null) onTwistDegrees = new FloatEvent(); return onTwistDegrees; } }
        [UnityEngine.Serialization.FormerlySerializedAs("onTwist")] [SerializeField] private FloatEvent onTwistDegrees;
